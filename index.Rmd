...
<ul class="menu">
          ...
          <li><a href="{{ site.github.repository_url }}">Explore <strong>Precipitation gradients</strong></a></li>
          <li><a href="{{ site.github.repository_url }}">Inspect <strong>macronutrient effects</strong></a></li>
        </ul>
```
