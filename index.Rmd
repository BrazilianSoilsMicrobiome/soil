...
<ul class="menu">
          ...
          <li><a href="{{ site.github.repository_url }}">Explore Precipitation <strong>Gradients</strong></a></li>
          <li><a href="{{ site.github.repository_url }}">Inspect Macronutrient <strong>effects</strong></a></li>
        </ul>
```
